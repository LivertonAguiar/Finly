...
const KNOWN_ALIASES: Record<string, { categoryId: string; subcategoryId?: string; name?: string; icon?: string }> = {
  ...
  'sub-mor-limpeza-utilidades': { categoryId: 'cat-desp-moradia', subcategoryId: 'sub-mor-limpeza-utilidades', name: 'Moradia', icon: '🏠' },
  'limpeza & utilidades': { categoryId: 'cat-desp-moradia', subcategoryId: 'sub-mor-limpeza-utilidades', name: 'Moradia', icon: '🏠' },
  'limpeza e utilidades': { categoryId: 'cat-desp-moradia', subcategoryId: 'sub-mor-limpeza-utilidades', name: 'Moradia', icon: '🏠' },
  'limpeza': { categoryId: 'cat-desp-moradia', subcategoryId: 'sub-mor-limpeza-utilidades', name: 'Moradia', icon: '🏠' },
  ...
  'sub-saude-oculos-lentes': { categoryId: 'cat-desp-saude', subcategoryId: 'sub-saude-oculos-lentes', name: 'Saúde', icon: '🩺' },
  'sub-sau-oculos': { categoryId: 'cat-desp-saude', subcategoryId: 'sub-saude-oculos-lentes', name: 'Saúde', icon: '🩺' },
  'oculos & lentes': { categoryId: 'cat-desp-saude', subcategoryId: 'sub-saude-oculos-lentes', name: 'Saúde', icon: '🩺' },
  'oculos e lentes': { categoryId: 'cat-desp-saude', subcategoryId: 'sub-saude-oculos-lentes', name: 'Saúde', icon: '🩺' },
  'oculos': { categoryId: 'cat-desp-saude', subcategoryId: 'sub-saude-oculos-lentes', name: 'Saúde', icon: '🩺' },
  'lentes': { categoryId: 'cat-desp-saude', subcategoryId: 'sub-saude-oculos-lentes', name: 'Saúde', icon: '🩺' },
  'otica': { categoryId: 'cat-desp-saude', subcategoryId: 'sub-saude-oculos-lentes', name: 'Saúde', icon: '🩺' },
