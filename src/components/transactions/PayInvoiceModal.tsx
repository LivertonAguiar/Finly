...
import { CreditCard as CardIcon, Calendar, CheckCircle2, AlertCircle, Clock, DollarSign, Wallet } from 'lucide-react';
...
export const PayInvoiceModal: React.FC<PayInvoiceModalProps> = ({ isOpen, onClose, initialCardId }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Pagar Fatura" maxWidth="lg">
      <form onSubmit={handlePay} className="space-y-4">
        ...
        <div className="pt-2 flex justify-end gap-2 border-t border-slate-100 dark:border-slate-800">
          ...
          >
            ...
            <span>{isInvoiceAlreadyPaid ? 'Fatura Já Paga ✓' : isSubmitting ? 'Processando...' : 'Pagar Fatura'}</span>
          </button>
        </div>
      </form>
    </Modal>
