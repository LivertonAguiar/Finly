...
export const FinlyLogo: React.FC<FinlyLogoProps> = ({
  ...
  return (
    <div className={`flex items-center gap-2.5 min-w-0 ${className}`}>
      <div
        className={`${current.box} bg-gradient-to-tr from-[#00a884] via-[#05c46b] to-[#00d2d3] flex items-center justify-center text-white font-black shadow-md shadow-emerald-500/20 shrink-0 select-none tracking-tighter`}
      >
        <svg
          viewBox="0 0 32 32"
          fill="none"
      ...
      {showText && (
        ...
        >
          Fin<span className="text-[#00a884]">ly</span>
        </span>
      )}
    </div>
  );
