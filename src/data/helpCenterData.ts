    ...
    steps: [
      {
        ...
        androidInstruction: 'Na parte inferior do celular, você tem acesso imediato a Principal, Transações, Planejamento e Mais, com suporte completo à área segura do aparelho.',
      },
      {
        stepNumber: 2,
