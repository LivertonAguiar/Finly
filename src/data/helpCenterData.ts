...
export const HELP_CATEGORIES: HelpCategoryDef[] = [
  ...
  {
    id: 'mobile_web',
    label: 'App Android vs Web',
    iconName: 'Smartphone',
    description: 'Diferenças de uso, notificações na barra, atualizações e gestos',
...
export const HELP_GUIDES: HelpGuide[] = [
    ...
    steps: [
      {
        ...
        androidInstruction: 'Toque na aba "Cartões" na barra inferior de navegação (ou acesse via Mais Opções).',
        callout: {
          area: 'sidebar',
          targetLabel: 'Menu Cartões',
          webDescription: '4º item da barra lateral esquerda',
          androidDescription: '3º ícone na barra inferior do celular',
          hotspotX: 12,
          hotspotY: 32,
        },
      },
    ...
    steps: [
      {
        ...
        androidInstruction: 'Na aba "Mais", selecione o item "Planejamento & Orçamentos".',
        callout: {
          area: 'sidebar',
          targetLabel: 'Item Planejamento',
          webDescription: '5º item do menu lateral',
          androidDescription: 'Card na central Mais Opções',
          hotspotX: 12,
          hotspotY: 40,
        },
      },
  ...
  },
  {
    ...
    title: 'Guia do Usuário: Versão Web no Computador vs. App Android',
    category: 'mobile_web',
    categoryLabel: 'App Android vs Web',
    summary: 'Entenda as particularidades de cada plataforma e tire o máximo proveito de ambas as experiências.',
    readTime: '3 min',
    badge: 'Guia Visual',
    steps: [
      {
        ...
        description: 'Interface adaptada para a ergonomia de cada tela.',
        webInstruction: '💻 No Computador: Barra lateral expansível à esquerda, atalhos de teclado, tabelas amplas e gráficos detalhados lado a lado.',
        androidInstruction: '📱 No Celular: Barra de navegação inferior com Speed-Dial em arco, gaveta lateral oculta e suporte completo à safe-area / entalhe da câmera.',
      },
      {
        stepNumber: 2,
        title: 'Lançamentos Rápidos com Menu em Arco no Celular',
        description: 'Agilidade máxima para lançamentos na rua.',
        webInstruction: '💻 No Computador: Clique no botão "+ Nova Transação" no topo ou pressione a tecla "N".',
        androidInstruction: '📱 No Celular: Toque no botão central com "+". Abre-se um leque com 4 atalhos rápidos: Receita, Despesa, Despesa de Cartão e Transferência.',
      },
      {
        stepNumber: 3,
        title: 'Notificações e Atualizações',
        description: 'Como cada plataforma se comunica com você.',
        webInstruction: '💻 No Computador: O app se atualiza automaticamente na nuvem sem necessidade de downloads. No primeiro acesso pós-atualização, exibe o painel de novidades.',
        androidInstruction: '📱 No Celular: Recebe notificações locais na barra do sistema (vencimentos de cartão e contas). As atualizações do APK podem ser baixadas na aba Sobre com 1 clique.',
      },
    ],
