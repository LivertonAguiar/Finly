    ...
    steps: [
      {
        ...
        androidInstruction: 'Toque na aba "Planejamento" (4º ícone da barra inferior) ou acesse pela aba "Mais" -> "Planejamento".',
        callout: {
          area: 'bottom_nav',
          targetLabel: 'Aba Planejamento',
          webDescription: '5º item do menu lateral',
          androidDescription: '4º ícone da barra inferior (Bandeira)',
          hotspotX: 70,
          hotspotY: 95,
        },
      },
